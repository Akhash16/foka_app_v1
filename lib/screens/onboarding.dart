    ...
    Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Image.network("https://www.aihr.com/wp-content/uploads/onboarding.png",fit: BoxFit.fill,),
          Padding(
      ...
      body: Builder(
        builder: (context) {
          return LiquidSwipe(
            ...
            slideIconWidget: const Icon(Icons.arrow_back_ios_outlined, color: Colors.black,),
